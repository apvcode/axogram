...
import static space.axolab.axogram.AndroidUtilities.isInAirplaneMode;
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            ...
            switch (viewType) {
                ...
                case VIEW_TYPE_SHADOW:
                    ...
                    Drawable shadowDrawable = Theme.getThemedDrawable(getContext(), space.axolab.axogram.R.drawable.greydivider, Theme.getColor(Theme.key_windowBackgroundGrayShadow, resourceProvider));
        ...
        listView.setOnItemClickListener((view, position) -> {
            ...
            if (item.viewType == VIEW_TYPE_HEADER) {
                ...
                try {
                    ...
                    builder.setNegativeButton(LocaleController.getString("Cancel", space.axolab.axogram.R.string.Cancel), null);
