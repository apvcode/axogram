...
public class ApplicationLoaderImpl extends ApplicationLoader {
    ...
    protected void startAppCenterInternal(Activity context) {
        if (space.axolab.axogram.BuildConfig.DEBUG) {
            return;
        }
        try {
            if (BuildVars.DEBUG_VERSION) {
                ...
                crashlytics.setCustomKey("version", getVersionName(space.axolab.axogram.BuildConfig.VERSION_NUM));
            ...
            if (BuildVars.DEBUG_VERSION) {
                ...
                String appHash = space.axolab.axogram.BuildConfig.APP_CENTER_HASH;
...
//        }
    ...
    public boolean isCustomUpdate() {
        return !TextUtils.isEmpty(space.axolab.axogram.BuildConfig.BETA_URL);
    }
