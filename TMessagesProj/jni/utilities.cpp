...
extern "C" JNIEXPORT jstring Java_space_axolab_axogram_Utilities_readlink(JNIEnv *env, jclass clazz, jstring path) {
...
extern "C" JNIEXPORT jstring Java_space_axolab_axogram_Utilities_readlinkFd(JNIEnv *env, jclass clazz, int fd) {
...
Java_space_axolab_axogram_Utilities_setupNativeCrashesListener(JNIEnv *env, jclass clazz,
                                                                 jstring path) {
