...
static const char *NativeByteBufferClassPathName = "space/axolab/axogram/tgnet/NativeByteBuffer";
...
static const char *ConnectionsManagerClassPathName = "space/axolab/axogram/tgnet/ConnectionsManager";
static JNINativeMethod ConnectionsManagerMethods[] = {
        ...
        {"native_checkProxy", "(ILjava/lang/String;ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Lspace/axolab/axogram/tgnet/RequestTimeDelegate;)J", (void *) checkProxy},
...
extern "C" int registerNativeTgNetFunctions(JavaVM *vm, JNIEnv *env) {
    ...
    jclass_RequestTimeDelegate = (jclass) env->NewGlobalRef(env->FindClass("space/axolab/axogram/tgnet/RequestTimeDelegate"));
    ...
    jclass_ConnectionsManager = (jclass) env->NewGlobalRef(env->FindClass("space/axolab/axogram/tgnet/ConnectionsManager"));
