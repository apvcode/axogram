...
JNIEXPORT void Java_space_axolab_axogram_Intro_setBackgroundColor(JNIEnv *env, jclass class, jfloat r, jfloat g, jfloat b, jfloat a) {
...
JNIEXPORT void Java_space_axolab_axogram_Intro_onDrawFrame(JNIEnv *env, jclass class, jint deltaMs) {
    if (surfaceCreated == 0) {
    ...
    if (current_page == 0) {
        ...
        telegram_plane.params.alpha = alpha;
        telegram_plane.params.position = xyzMake(0, 0, 0);
        telegram_plane.params.scale = xyzMake(1, 1, 1);
        glBlendFunc(GL_SRC_ALPHA, GL_ONE_MINUS_SRC_ALPHA);
        draw_textured_shape(&telegram_plane, main_matrix, NORMAL);
    ...
    if (current_page == 0) {
        rglNormalDraw();
        if (direct == 0) {
            telegram_plane.params.alpha = t(0, 1, 0, duration_const * 0.8f, Linear);
            telegram_plane.params.position = xyzMake(0, 0, 0);
            scale = t(0.92f, 1, 0.0f, duration_const * 0.6f, EaseOut);
        ...
        rglNormalDraw();
        if (direct == 1) {
            telegram_plane.params.alpha = t(1, 0, 0, duration_const * 0.6f, EaseOut);
            telegram_plane.params.position = xyzMake(0, 0, 0);
            scale = t(1, 0.92f, 0.0f, duration_const * 0.6f, EaseOut);
            telegram_plane.params.scale = xyzMake(scale, scale, 1);
            glBlendFunc(GL_SRC_ALPHA, GL_ONE_MINUS_SRC_ALPHA);
            draw_textured_shape(&telegram_plane, main_matrix, NORMAL);
        }
...
JNIEXPORT void Java_space_axolab_axogram_Intro_setScrollOffset(JNIEnv *env, jclass class, float a_offset) {
    scroll_offset = a_offset;
}

JNIEXPORT void Java_space_axolab_axogram_Intro_setPage(JNIEnv *env, jclass class, int32_t page) {
...
JNIEXPORT void Java_space_axolab_axogram_Intro_setDate(JNIEnv *env, jclass class, float a) {
    date = a;
}

JNIEXPORT void Java_space_axolab_axogram_Intro_setIcTextures(JNIEnv *env, jclass class, GLuint a_ic_bubble_dot, GLuint a_ic_bubble, GLuint a_ic_cam_lens, GLuint a_ic_cam, GLuint a_ic_pencil, GLuint a_ic_pin, GLuint a_ic_smile_eye, GLuint a_ic_smile, GLuint a_ic_videocam) {
...
JNIEXPORT void Java_space_axolab_axogram_Intro_setTelegramTextures(JNIEnv *env, jclass class, GLuint a_telegram_sphere, GLuint a_telegram_plane, GLuint a_telegram_mask) {
    telegram_sphere_texture = a_telegram_sphere;
    telegram_plane_texture = a_telegram_plane;
    telegram_mask_texture = a_telegram_mask;
}

JNIEXPORT void Java_space_axolab_axogram_Intro_setFastTextures(JNIEnv *env, jclass class, GLuint a_fast_body, GLuint a_fast_spiral, GLuint a_fast_arrow, GLuint a_fast_arrow_shadow) {
...
JNIEXPORT void Java_space_axolab_axogram_Intro_setFreeTextures(JNIEnv *env, jclass class, GLuint a_knot_up, GLuint a_knot_down) {
    free_knot_up_texture = a_knot_up;
    free_knot_down_texture = a_knot_down;
}

JNIEXPORT void Java_space_axolab_axogram_Intro_setPowerfulTextures(JNIEnv *env, jclass class, GLuint a_powerful_mask, GLuint a_powerful_star, GLuint a_powerful_infinity, GLuint a_powerful_infinity_white) {
...
JNIEXPORT void Java_space_axolab_axogram_Intro_setPrivateTextures(JNIEnv *env, jclass class, GLuint a_private_door, GLuint a_private_screw) {
    private_door_texture = a_private_door;
    private_screw_texture = a_private_screw;
}

JNIEXPORT void Java_space_axolab_axogram_Intro_onSurfaceCreated(JNIEnv *env, jclass class) {
    ...
    telegram_mask = create_textured_rectangle(CSizeMake(200, 150), telegram_mask_texture);
    telegram_plane = create_textured_rectangle(CSizeMake(184, 184), telegram_plane_texture);
...
JNIEXPORT void Java_space_axolab_axogram_Intro_onSurfaceChanged(JNIEnv *env, jclass class, int32_t a_width_px, int32_t a_height_px, float a_scale_factor, int32_t a1) {
