...
public class BlurringShader {
    ...
    public void draw(float[] oesMatrix, int texture, int textureWidth, int textureHeight) {
        ...
        space.axolab.axogram.ui.Components.Paint.Shader.SetColorUniform(p.gradientTopHandle, gradientTop);
        space.axolab.axogram.ui.Components.Paint.Shader.SetColorUniform(p.gradientBottomHandle, gradientBottom);
