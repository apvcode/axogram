...
import space.axolab.axogram.ui.Components.AttachableDrawable;
    ...
    protected View inflateContent(boolean setContent) {
        ...
        if (hasButtons) {
            ...
            if (negative2ButtonText != null) {
                ...
                textView.setBackground(Theme.getRoundRectSelectorDrawable(dp(6), getThemedColor(Theme.key_dialogTextGray3)));
                textView.setPadding(dp(12), 0, dp(12), 0);
                if (verticalButtons) {
