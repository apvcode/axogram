...
public class GroupCallFullscreenAdapter extends RecyclerListView.SelectionAdapter {
    ...
    public class GroupCallUserCell extends FrameLayout implements GroupCallStatusIcon.Callback {
        ...
        space.axolab.axogram.ui.Cells.GroupCallUserCell.AvatarWavesDrawable avatarWavesDrawable = new space.axolab.axogram.ui.Cells.GroupCallUserCell.AvatarWavesDrawable(AndroidUtilities.dp(26), AndroidUtilities.dp(29));
