...
import static space.axolab.axogram.AndroidUtilities.dpf2;
import static space.axolab.axogram.AndroidUtilities.ilerp;
import static space.axolab.axogram.AndroidUtilities.lerp;
import static space.axolab.axogram.ContactsController.PRIVACY_RULES_TYPE_ADDED_BY_PHONE;
import static space.axolab.axogram.LocaleController.formatPluralString;
import static space.axolab.axogram.LocaleController.formatPluralStringComma;
import static space.axolab.axogram.LocaleController.formatString;
import static space.axolab.axogram.LocaleController.getString;
import static space.axolab.axogram.ui.Stars.StarGiftSheet.replaceUnderstood;
import static space.axolab.axogram.ui.Stars.StarsIntroActivity.formatStarsAmountShort;
import static space.axolab.axogram.ui.bots.AffiliateProgramFragment.percents;
...
import space.axolab.axogram.BirthdayController;
...
import space.axolab.axogram.Emoji;
import space.axolab.axogram.FileLoader;
import space.axolab.axogram.FileLog;
import space.axolab.axogram.FlagSecureReason;
import space.axolab.axogram.ImageLoader;
import space.axolab.axogram.ImageLocation;
import space.axolab.axogram.ImageReceiver;
import space.axolab.axogram.LanguageDetector;
...
import space.axolab.axogram.MessagesStorage;
import space.axolab.axogram.NotificationCenter;
import space.axolab.axogram.NotificationsController;
...
import space.axolab.axogram.tgnet.SerializedData;
import space.axolab.axogram.tgnet.TLObject;
import space.axolab.axogram.tgnet.TLRPC;
import space.axolab.axogram.tgnet.tl.TL_account;
import space.axolab.axogram.tgnet.tl.TL_bots;
import space.axolab.axogram.tgnet.tl.TL_fragment;
import space.axolab.axogram.tgnet.tl.TL_stars;
...
import space.axolab.axogram.ui.ActionBar.ActionBarMenuSubItem;
import space.axolab.axogram.ui.ActionBar.ActionBarPopupWindow;
...
import space.axolab.axogram.ui.ActionBar.INavigationLayout;
import space.axolab.axogram.ui.ActionBar.OKLCH;
...
import space.axolab.axogram.ui.Business.OpeningHoursActivity;
import space.axolab.axogram.ui.Business.ProfileHoursCell;
import space.axolab.axogram.ui.Business.ProfileLocationCell;
import space.axolab.axogram.ui.Cells.AboutLinkCell;
import space.axolab.axogram.ui.Cells.AnimatedStatusView;
import space.axolab.axogram.ui.Cells.CheckBoxCell;
import space.axolab.axogram.ui.Cells.DividerCell;
import space.axolab.axogram.ui.Cells.GraySectionCell;
import space.axolab.axogram.ui.Cells.HeaderCell;
import space.axolab.axogram.ui.Cells.NotificationsCheckCell;
import space.axolab.axogram.ui.Cells.ProfileChannelCell;
import space.axolab.axogram.ui.Cells.SettingsSearchCell;
import space.axolab.axogram.ui.Cells.SettingsSuggestionCell;
import space.axolab.axogram.ui.Cells.ShadowSectionCell;
import space.axolab.axogram.ui.Cells.TextCell;
import space.axolab.axogram.ui.Cells.TextCheckCell;
import space.axolab.axogram.ui.Cells.TextDetailCell;
import space.axolab.axogram.ui.Cells.TextInfoPrivacyCell;
import space.axolab.axogram.ui.Cells.UserCell;
import space.axolab.axogram.ui.Components.AlertsCreator;
import space.axolab.axogram.ui.Components.AnimatedColor;
import space.axolab.axogram.ui.Components.AnimatedEmojiDrawable;
import space.axolab.axogram.ui.Components.AnimatedEmojiSpan;
import space.axolab.axogram.ui.Components.AnimatedFileDrawable;
import space.axolab.axogram.ui.Components.AnimatedFloat;
import space.axolab.axogram.ui.Components.AnimatedTextView;
import space.axolab.axogram.ui.Components.AnimationProperties;
import space.axolab.axogram.ui.Components.AudioPlayerAlert;
import space.axolab.axogram.ui.Components.AutoDeletePopupWrapper;
import space.axolab.axogram.ui.Components.AvatarDrawable;
import space.axolab.axogram.ui.Components.BackButtonMenu;
import space.axolab.axogram.ui.Components.BackupImageView;
import space.axolab.axogram.ui.Components.Bulletin;
import space.axolab.axogram.ui.Components.BulletinFactory;
import space.axolab.axogram.ui.Components.ButtonBounce;
import space.axolab.axogram.ui.Components.CanvasButton;
import space.axolab.axogram.ui.Components.ChatActivityInterface;
import space.axolab.axogram.ui.Components.ChatAvatarContainer;
import space.axolab.axogram.ui.Components.ChatNotificationsPopupWrapper;
import space.axolab.axogram.ui.Components.ColoredImageSpan;
import space.axolab.axogram.ui.Components.CombinedDrawable;
import space.axolab.axogram.ui.Components.CrossfadeDrawable;
import space.axolab.axogram.ui.Components.CubicBezierInterpolator;
import space.axolab.axogram.ui.Components.DotDividerSpan;
import space.axolab.axogram.ui.Components.EmojiPacksAlert;
import space.axolab.axogram.ui.Components.EmptyStubSpan;
import space.axolab.axogram.ui.Components.FloatingDebug.FloatingDebugController;
import space.axolab.axogram.ui.Components.Forum.ForumUtilities;
import space.axolab.axogram.ui.Components.HintView;
import space.axolab.axogram.ui.Components.IdenticonDrawable;
import space.axolab.axogram.ui.Components.ImageUpdater;
import space.axolab.axogram.ui.Components.InstantCameraView;
import space.axolab.axogram.ui.Components.ItemOptions;
import space.axolab.axogram.ui.Components.JoinGroupAlert;
import space.axolab.axogram.ui.Components.LayoutHelper;
import space.axolab.axogram.ui.Components.LinkSpanDrawable;
import space.axolab.axogram.ui.Components.MediaActivity;
import space.axolab.axogram.ui.Components.MessagePrivateSeenView;
import space.axolab.axogram.ui.Components.ProfileActionsView;
import space.axolab.axogram.ui.Components.ProfileGalleryBlurView;
import space.axolab.axogram.ui.Components.Paint.PersistColorPalette;
import space.axolab.axogram.ui.Components.Premium.LimitPreviewView;
import space.axolab.axogram.ui.Components.Premium.PremiumFeatureBottomSheet;
import space.axolab.axogram.ui.Components.Premium.PremiumGradient;
import space.axolab.axogram.ui.Components.Premium.PremiumPreviewBottomSheet;
import space.axolab.axogram.ui.Components.Premium.ProfilePremiumCell;
import space.axolab.axogram.ui.Components.Premium.boosts.UserSelectorBottomSheet;
import space.axolab.axogram.ui.Components.ProfileGalleryView;
import space.axolab.axogram.ui.Components.ProfileGooeyView;
import space.axolab.axogram.ui.Components.ProfileMusicView;
...
import space.axolab.axogram.ui.Components.Reactions.ReactionsLayoutInBubble;
...
import space.axolab.axogram.ui.Components.ScamDrawable;
import space.axolab.axogram.ui.Components.ShareAlert;
import space.axolab.axogram.ui.Components.SharedMediaLayout;
import space.axolab.axogram.ui.Components.SizeNotifierFrameLayout;
import space.axolab.axogram.ui.Components.StarRatingView;
import space.axolab.axogram.ui.Components.StickerEmptyView;
import space.axolab.axogram.ui.Components.TagEditCell;
import space.axolab.axogram.ui.Components.TimerDrawable;
import space.axolab.axogram.ui.Components.TranslateAlert2;
import space.axolab.axogram.ui.Components.TranslateAlert3;
import space.axolab.axogram.ui.Components.TypefaceSpan;
import space.axolab.axogram.ui.Components.UItem;
import space.axolab.axogram.ui.Components.UndoView;
import space.axolab.axogram.ui.Components.VectorAvatarThumbDrawable;
import space.axolab.axogram.ui.Components.blur3.BlurredBackgroundDrawableViewFactory;
import space.axolab.axogram.ui.Components.blur3.DownscaleScrollableNoiseSuppressor;
import space.axolab.axogram.ui.Components.blur3.ViewGroupPartRenderer;
import space.axolab.axogram.ui.Components.blur3.capture.IBlur3Capture;
import space.axolab.axogram.ui.Components.blur3.drawable.BlurredBackgroundDrawable;
import space.axolab.axogram.ui.Components.blur3.drawable.color.BlurredBackgroundColorProviderThemed;
import space.axolab.axogram.ui.Components.blur3.source.BlurredBackgroundSourceColor;
import space.axolab.axogram.ui.Components.blur3.source.BlurredBackgroundSourceRenderNode;
import space.axolab.axogram.ui.Components.chat.ViewPositionWatcher;
import space.axolab.axogram.ui.Components.voip.VoIPHelper;
import space.axolab.axogram.ui.Gifts.GiftSheet;
import space.axolab.axogram.ui.Stars.BotStarsActivity;
import space.axolab.axogram.ui.Stars.BotStarsController;
import space.axolab.axogram.ui.Stars.ProfileGiftsView;
import space.axolab.axogram.ui.Stars.StarGiftPatterns;
import space.axolab.axogram.ui.Stars.StarGiftSheet;
import space.axolab.axogram.ui.Stars.StarsController;
import space.axolab.axogram.ui.Stars.StarsIntroActivity;
import space.axolab.axogram.ui.Stories.ProfileStoriesView;
import space.axolab.axogram.ui.Stories.StoriesController;
import space.axolab.axogram.ui.Stories.StoriesListPlaceProvider;
import space.axolab.axogram.ui.Stories.StoryViewer;
import space.axolab.axogram.ui.Stories.recorder.ButtonWithCounterView;
import space.axolab.axogram.ui.Stories.recorder.DualCameraView;
import space.axolab.axogram.ui.Stories.recorder.HintView2;
import space.axolab.axogram.ui.Stories.recorder.StoryRecorder;
import space.axolab.axogram.ui.TON.TONIntroActivity;
import space.axolab.axogram.ui.bots.AffiliateProgramFragment;
import space.axolab.axogram.ui.bots.BotBiometry;
import space.axolab.axogram.ui.bots.BotDownloads;
import space.axolab.axogram.ui.bots.BotLocation;
import space.axolab.axogram.ui.bots.BotWebViewAttachedSheet;
import space.axolab.axogram.ui.bots.ChannelAffiliateProgramsFragment;
import space.axolab.axogram.ui.bots.SetupEmojiStatusSheet;
    ...
    private boolean editRow(View view, int position) {
        ...
        if (position == bizHoursRow) {
            ...
            itemOptions.add(R.drawable.msg_edit, getString(R.string.ProfileLocationEdit), () -> {
                presentFragment(new space.axolab.axogram.ui.Business.LocationActivity());
            });
