...
import space.axolab.axogram.MrzRecognizer;
...
import space.axolab.axogram.SecureDocument;
import space.axolab.axogram.SecureDocumentKey;
    ...
    private void createIdentityInterface(final Context context) {
        ...
        if (currentDocumentsType != null) {
            ...
            scanDocumentCell.setOnClickListener(v -> {
                ...
                CameraScanActivity fragment = new CameraScanActivity(space.axolab.axogram.ui.CameraScanActivity.TYPE_MRZ);
