...
import static space.axolab.axogram.AndroidUtilities.replaceSingleLinkBold;
...
import static space.axolab.axogram.ui.Components.Premium.LimitReachedBottomSheet.TYPE_BOOSTS_FOR_USERS;
...
import space.axolab.axogram.AutoDeleteMediaTask;
import space.axolab.axogram.BackupAgent;
import space.axolab.axogram.BetaUpdate;
...
import space.axolab.axogram.OpenAttachedMenuBotReceiver;
import space.axolab.axogram.PushListenerController;
import space.axolab.axogram.R;
import space.axolab.axogram.SendMessagesHelper;
import space.axolab.axogram.SharedConfig;
import space.axolab.axogram.SharedPrefsHelper;
import space.axolab.axogram.TopicsController;
...
import space.axolab.axogram.pip.activity.IPipActivity;
import space.axolab.axogram.pip.activity.IPipActivityHandler;
import space.axolab.axogram.pip.activity.IPipActivityListener;
import space.axolab.axogram.utils.FrameMetricsOverlayView;
import space.axolab.axogram.voip.VideoCapturerDevice;
import space.axolab.axogram.voip.VoIPGroupNotification;
import space.axolab.axogram.voip.VoIPPendingCall;
import space.axolab.axogram.voip.VoIPPreNotificationService;
...
import space.axolab.axogram.tgnet.TLParseException;
...
import space.axolab.axogram.tgnet.tl.TL_forum;
import space.axolab.axogram.tgnet.tl.TL_stars;
import space.axolab.axogram.tgnet.tl.TL_stories;
import space.axolab.axogram.ui.ActionBar.ActionBarLayout;
import space.axolab.axogram.ui.ActionBar.AlertDialog;
import space.axolab.axogram.ui.ActionBar.BaseFragment;
import space.axolab.axogram.ui.ActionBar.BottomSheetTabs;
import space.axolab.axogram.ui.ActionBar.BottomSheetTabsOverlay;
import space.axolab.axogram.ui.ActionBar.DrawerLayoutContainer;
import space.axolab.axogram.ui.ActionBar.INavigationLayout;
import space.axolab.axogram.ui.ActionBar.Theme;
import space.axolab.axogram.ui.Cells.ChatMessageCell;
import space.axolab.axogram.ui.Cells.LanguageCell;
import space.axolab.axogram.ui.Components.AlertsCreator;
import space.axolab.axogram.ui.Components.AppIconBulletinLayout;
import space.axolab.axogram.ui.Components.AttachBotIntroTopView;
import space.axolab.axogram.ui.Components.AudioPlayerAlert;
import space.axolab.axogram.ui.Components.BatteryDrawable;
import space.axolab.axogram.ui.Components.BlockingUpdateView;
...
import space.axolab.axogram.ui.Components.EmbedBottomSheet;
import space.axolab.axogram.ui.Components.EmojiPacksAlert;
import space.axolab.axogram.ui.Components.FireworksOverlay;
...
import space.axolab.axogram.ui.Components.GroupCallPip;
import space.axolab.axogram.ui.Components.JoinGroupAlert;
import space.axolab.axogram.ui.Components.LayoutHelper;
import space.axolab.axogram.ui.Components.PasscodeView;
import space.axolab.axogram.ui.Components.PasscodeViewDialog;
import space.axolab.axogram.ui.Components.PhonebookShareAlert;
import space.axolab.axogram.ui.Components.PipRoundVideoView;
import space.axolab.axogram.ui.Components.PipVideoOverlay;
import space.axolab.axogram.ui.Components.Premium.LimitReachedBottomSheet;
import space.axolab.axogram.ui.Components.Premium.boosts.BoostPagerBottomSheet;
import space.axolab.axogram.ui.Components.Premium.boosts.GiftInfoBottomSheet;
...
import space.axolab.axogram.ui.Components.SearchTagsList;
import space.axolab.axogram.ui.Components.SharingLocationsAlert;
import space.axolab.axogram.ui.Components.SizeNotifierFrameLayout;
import space.axolab.axogram.ui.Components.StickerSetBulletinLayout;
import space.axolab.axogram.ui.Components.StickersAlert;
import space.axolab.axogram.ui.Components.TermsOfServiceView;
import space.axolab.axogram.ui.Components.TextStyleSpan;
import space.axolab.axogram.ui.Components.ThemeEditorView;
import space.axolab.axogram.ui.Components.UndoView;
import space.axolab.axogram.ui.Components.inset.WindowAnimatedInsetsProvider;
import space.axolab.axogram.ui.Components.poll.PollAttachedMediaPack;
import space.axolab.axogram.ui.Components.spoilers.SpoilerEffect2;
import space.axolab.axogram.ui.Components.voip.RTMPStreamPipOverlay;
import space.axolab.axogram.ui.Components.voip.VoIPHelper;
import space.axolab.axogram.ui.Gifts.GiftSheet;
import space.axolab.axogram.ui.Stars.ISuperRipple;
import space.axolab.axogram.ui.Gifts.AuctionJoinSheet;
import space.axolab.axogram.ui.Stars.StarGiftPreviewSheet;
...
import space.axolab.axogram.ui.Stars.SuperRipple;
...
import space.axolab.axogram.ui.Stories.recorder.StoryEntry;
import space.axolab.axogram.ui.Stories.recorder.StoryRecorder;
import space.axolab.axogram.ui.Stories.LiveStoryPipOverlay;
...
import space.axolab.axogram.ui.bots.WebViewRequestProps;
...
//            dismissAllWeb();
        ...
        if ((flags & Intent.FLAG_ACTIVITY_LAUNCHED_FROM_HISTORY) == 0) {
            if (intent != null && intent.getAction() != null && !restore) {
                ...
                } else if ("space.axolab.axogram.CREATE_STICKER_PACK".equals(intent.getAction())) {
                    try {
                                ...
                                try (Cursor cursor = getContentResolver().query(intent.getData(), null, null, null, null)) {
                                    if (cursor != null) {
                                        if (cursor.moveToFirst()) {
                                            ...
                                            if (TextUtils.equals(mimeType, "vnd.android.cursor.item/vnd.space.axolab.axogram.android.call")) {
                                                audioCallUser = true;
                                            } else if (TextUtils.equals(mimeType, "vnd.android.cursor.item/vnd.space.axolab.axogram.android.call.video")) {
                                                videoCallUser = true;
                                            }
                                        }
                                    }
