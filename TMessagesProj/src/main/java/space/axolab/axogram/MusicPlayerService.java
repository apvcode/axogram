...
public class MusicPlayerService extends Service implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static final String NOTIFY_PREVIOUS = "space.axolab.axogram.android.musicplayer.previous";
    public static final String NOTIFY_CLOSE = "space.axolab.axogram.android.musicplayer.close";
    public static final String NOTIFY_PAUSE = "space.axolab.axogram.android.musicplayer.pause";
    public static final String NOTIFY_PLAY = "space.axolab.axogram.android.musicplayer.play";
    public static final String NOTIFY_NEXT = "space.axolab.axogram.android.musicplayer.next";
    public static final String NOTIFY_SEEK = "space.axolab.axogram.android.musicplayer.seek";
