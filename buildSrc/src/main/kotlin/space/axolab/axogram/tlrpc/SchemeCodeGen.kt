...
import space.axolab.axogram.tlrpc.models.TlParam
import space.axolab.axogram.tlrpc.models.TlParamOptionalKey
import space.axolab.axogram.tlrpc.schema.TlSchemaParamType
import space.axolab.axogram.tlrpc.models.TlParams
import space.axolab.axogram.tlrpc.schema.TlSchemaPrimitiveType

object SchemeCodeGen {
    private val CLASS_OUTPUT = ClassName("space.axolab.axogram.tgnet", "OutputSerializedData")
    ...
    fun generateDataClass(tl: TlObjectWithLayer, superclass: TypeName?): TypeSpec {
        ...
        if (superclass == null) {
            builder.addSuperinterface(ClassName("space.axolab.axogram.tgnet.model", "TlGen_Object"))
        }
        ...
        return when (type) {
            ...
            is TlSchemaParamType.Primary.Object -> {
                if (type.name == "Bool") {
                    ...
                    ClassName("space.axolab.axogram.tgnet.model.generated", "TlGen_" + type.name.replace('.', '_'))
                }
            }
            ...
            is TlSchemaParamType.Primary.X -> ClassName("space.axolab.axogram.tgnet.model", "TlGen_Object")
