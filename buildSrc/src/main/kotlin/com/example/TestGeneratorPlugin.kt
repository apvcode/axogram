...
tlSourcesDir = File(project.rootDir, "TMessagesProj/src/main/java/space/axolab/axogram/tgnet")
             tlSourcesDirectDir = File(project.rootDir, "TMessagesProj_AppStandalone/src/main/java/space/axolab/axogram/tgnet")
