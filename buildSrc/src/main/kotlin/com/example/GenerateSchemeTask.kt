...
import space.axolab.axogram.tlrpc.SchemeAllLayersParser
import space.axolab.axogram.tlrpc.SchemeCodeGen
import space.axolab.axogram.tlrpc.SchemeTlValidator
import space.axolab.axogram.tlrpc.models.RULES
import space.axolab.axogram.tlrpc.models.TlObjectWithLayer
import space.axolab.axogram.tlrpc.schema.TlSchemaJsonParser
import space.axolab.axogram.tlrpc.telegram.TelegramCodeParser
import space.axolab.axogram.tlrpc.telegram.TelegramTlClass
import java.io.File
...
abstract class GenerateSchemeTask : DefaultTask() {
    ...
    private fun generateSchemeClassForType(
        ...
        val packageName = "space.axolab.axogram.tgnet.model.generated"
        ...
        val sealedClassBuilder = TypeSpec.classBuilder(sealedClassName)
            ...
            .addSuperinterface(ClassName("space.axolab.axogram.tgnet.model", "TlGen_Object"))
        ...
        FileSpec.builder(packageName, sealedClassName)
            .addImport("space.axolab.axogram.tgnet.model", "TlGen_Object", "TlGen_Vector")
    ...
    private fun generateSchemeTestClassForType(
        ...
        val packageName = "space.axolab.axogram.tgnet.test.generated"
        ...
        val testActualBuilder = TypeSpec.classBuilder("Test_Actual")
            .superclass(ClassName("space.axolab.axogram.tgnet.test", "BaseSchemeTest"))
        ...
        for (constructor in constructors) {
            ...
            val lines = lt[constructor.tl.key.name.type]?.map { clz ->
                ...
                "test_TLdeserialize(space.axolab.axogram.tgnet.model.generated.TlGen_${type}.${constructor.codegenDataClassName}::class, " +
